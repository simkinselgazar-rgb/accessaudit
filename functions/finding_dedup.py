...
async def _llm_dedupe_findings(
    ...
    selector paths (observed on a university-site SC 1.1.1 run: 3 sources flagged the
    ...
    example_block = (
        ...
        "    element: a\n"
        "    issue: The accessible name (aria-label) 'University named a top producer of prestigious national awards' does not contain the visible text label 'Read more', violating WCAG 2.5.3.\n\n"
        ...
        "    issue: The accessible name 'University named a top producer of prestigious national awards' does not contain the visible text label 'Read more', violating WCAG 2.5.3.\n"
        "</input_findings>\n"
        "<output_clusters>\n"
        "{ \"clusters\": [\n"
        ...
        "a top producer of prestigious national awards') and the identical "
