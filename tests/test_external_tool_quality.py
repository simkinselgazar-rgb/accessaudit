...
Three issue categories these tests pin (all discovered during a
2026-05-09 university-site live run):
...
def test_ibm_contrast_dropped_when_andi_says_bg_image():
    """The exact university-site SC 1.4.3 false positive: text in `<article>` over
...
def test_ibm_focus_visible_dropped_when_pixels_show_visible_focus():
    """Pre-fix university-site SC 2.4.7: 40 ibm_eac findings vs 3 from the
