...
Two structural bugs found on ASU live runs that these tests pin:
...
def test_judge_returning_empty_final_findings_clears_result_findings():
    """The exact ASU SC 3.2.3 failure: judge returned
...
def test_partial_supports_with_zero_findings_downgrades_to_supports():
    """The ASU run #4 SC 2.5.1 case: verdict was Partially Supports
