...
class Check_1_4_4(BaseCheck):
    ...
    async def run_programmatic(
        ...
        # (verified on a university site 2026-05-28: all 6 programmatic 1.4.4 findings
        ...
        # carousel false positives across both a university site and a community college site. SC promoted
...
class Check_1_4_5(BaseCheck):
    ...
    async def run_programmatic(
        ...
        # into the image."
        #
        # Verified false positive on a university-site run 20260506_112508_bb25cbfd:
...
class Check_1_4_11(BaseCheck):
    ...
    async def run_programmatic(
        ...
        for ntc in (capture_data.nontext_contrast or []):
            ...
            # (observed on a university site's maroon submit/radio buttons and the
